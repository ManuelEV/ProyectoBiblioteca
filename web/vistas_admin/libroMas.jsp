        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li cla><a href="/Biblioteca/vistas_admin/estadisticas.jsp">Estadísticas</a></li>
                    <li ><a href="/Biblioteca/vistas_admin/SolicitudesLibros">Libros reservados</a></li>
                    <li ss="active"><a href="/Biblioteca/vistas_admin/editar.jsp">Editar</a></li>
...
<!--                    <li ><a href="/Biblioteca/vistas_admin/perfil.jsp"><span class="glyphicon glyphicon-user"></span> Mi perfil</a></li>-->
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li ss="active"><a href="/Biblioteca/vistas_admin/libroMas.jsp">Libro+</a></li>
